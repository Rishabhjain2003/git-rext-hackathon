            ...
            <div className="container py-5">
                ...
                <div className='row'>
                    <div className='col-md-4 align-items-center my-5 py-5 '>
                        <img src="https://www.meraportfolio.com/images/eq_icon1.png" height='150vh' className='img-hov' alt="img"/>
                        <h3 className='img-hov-txt py-3' >Large Cap Fund</h3>
                    </div>
                    <div className='col-md-4 align-items-center my-5 py-5 '>
                        <img src="https://www.meraportfolio.com/images/eq_icon2.png" height='150vh' className='img-hov' alt="img"/>
                        <h3 className='img-hov-txt py-3' >Mid & Small cap Fund</h3>
                    </div>
                    <div className='col-md-4 align-items-center my-5 py-5 '>
                        <img src="https://www.meraportfolio.com/images/eq_icon3.png" height='150vh' className='img-hov' alt="img"/>
